...
function OrderHistory() {
  ...
  const filteredOrders = (orders, searchTerm) => {
    const filteredOrders = orders.filter((order) => {
      const searchTermMatched = !searchTerm.trim() ||
  ...
  return (
    <div style={{ display: "flex" }}>
      ...
      <div className="container-fluid mt-5">
        ...
        >
          <div className="container-fluid d-flex" style={{justifyContent:"space-between", alignItems:"center"}}>
            <div className="fromdate-box d-flex">
              <label style={{fontWeight:"600",whiteSpace:"nowrap",marginRight:"13px",display:"flex",justifyContent:"center",alignItems:"center"}}>From Date :</label>
              <DatePicker
                selected={startDate}
            ...
            <div className="todate-box d-flex">
              <label style={{ fontWeight:"600",whiteSpace:"nowrap",marginRight:"13px",display:"flex",justifyContent:"center",alignItems:"center"}}>To Date :</label>
              <DatePicker
                selected={endDate}
            ...
            <tbody>
              {filteredDataWithDateRange.map((order, index) => (
                <tr key={order.orderNo}>
                  ...
                  <td>{order.deliveryBoy ? order.deliveryBoy : <p></p>}</td>
                </tr>
              ))}
            </tbody>
          </table>
